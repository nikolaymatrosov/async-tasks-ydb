...
## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#introduction)Introduction
...
## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#install-goose)Install goose
...
## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#launch-arguments-goose)Launch arguments goose
...
## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#ydb-connection-string)YDB connection string
...
## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#directory-with-migration-files)Directory with migration files
...
## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#managing-migrations-using-goose)Managing migrations using goose

### [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#creating-migration-files-and-applying-to-database)Creating migration files and applying to database
...
![YDB UI after the first migration](https://ydb.tech/docs/en/integrations/migration/docs-assets/ydb-platform--ydb/rev/04d98067a87e57da2366fd7faadee33dda16363f/en/integrations/migration/_assets/goose-ydb-ui-after-first-migration.png)
...
![YDB UI after apply second migration](https://ydb.tech/docs/en/integrations/migration/docs-assets/ydb-platform--ydb/rev/04d98067a87e57da2366fd7faadee33dda16363f/en/integrations/migration/_assets/goose-ydb-ui-after-second-migration.png)

All subsequent migration files should be created in the same way.

### [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#downgrading-migrations)Downgrading migrations
...
![YDB UI after apply first migration](https://ydb.tech/docs/en/integrations/migration/docs-assets/ydb-platform--ydb/rev/04d98067a87e57da2366fd7faadee33dda16363f/en/integrations/migration/_assets/goose-ydb-ui-after-first-migration.png)

## [](https://ydb.tech/docs/en/integrations/migration/en/integrations/migration/goose?version=v25.2#short-list-of-goose-commands)Short list of "goose" commands
